...
**Last updated: 2026-09-24. Phase: stage C partial implementation and AI-native research pivot. Next: build a bounded ordinary construction action surface, then run a model-chosen goal episode on a copied new game.** The [verification policy](10-verification.md) defines what each status means; the [research plan](../docs/AI-NATIVE-RESEARCH.md) defines the experiment.
