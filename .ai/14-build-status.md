...
**Last updated: 2026-09-24. Phase: stage C partial implementation. Next: use the game's validated build path from a bounded bridge action, then connect power, ore input, and an iron recipe on a copied save.** The [verification policy](10-verification.md) defines what each status means.
